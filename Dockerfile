...
RUN cd client && npm config set fund false && npm config set audit false && npm config set maxsockets 3 && \
...
RUN cd server && npm config set fund false && npm config set audit false && npm config set maxsockets 3 && \

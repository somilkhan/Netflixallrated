    ...
    <div className="flex items-center gap-2 px-5 pb-2 pt-1">
      ...
      <div className="relative">
        <select
          ...
          className="appearance-none bg-white/[0.03] border border-white/[0.08] rounded-md pl-2.5 pr-6 py-1 font-mono text-[11px] text-white/70 hover:border-white/[0.16] focus:border-white/[0.22] focus:text-white/80 focus:outline-none cursor-pointer transition-all duration-200"
        >

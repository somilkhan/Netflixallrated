...
function RowWrapper({
  ...
  // Leverage triggerOnce: true to immediately disconnect/unobserve the row once it is in view,
  // preventing persistent CPU overhead from continuous intersection checking during scroll.

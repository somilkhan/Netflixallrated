...
export default function SearchResults() {
  ...
  // Optimization: Do not disconnect sentinel immediately, and reset its state
  // to false when out of view so scrolling down can trigger loading the next page again.
